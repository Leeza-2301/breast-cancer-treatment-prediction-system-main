...
const getChatResponse = async (req, res) => {
    try {
        ...
        const chatCompletion = await groq.chat.completions.create({
            ...
            top_p: 1,
            stream: false, // Set to false to return a complete JSON response compatible with the frontend
            stop: null
        });

        // The Groq SDK response format is compatible with the OpenAI format the frontend expects
